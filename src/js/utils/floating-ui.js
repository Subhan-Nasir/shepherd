...
export function setupTooltip(step) {
    ...
    let target = attachToOptions.find(attachTo => {
        if (attachTo.on && attachTo.element) {
            return true;
        }
    ...
    step.target = attachToOptions.find(attachTo => {
        if (attachTo.on && attachTo.element) {
            return true;
        }
...
export function getFloatingUIOptions(attachToOptions, step) {
    ...
    if (!shouldCenter) {
        ...
        options.placement = attachToOptions.find(item => {
