...
<div class="shepherd-dots">
  {#each [...Array(numSteps).keys()] as i }
    {#if i < currentStepIndex}
      <div class="shepherd-dot" style="--dot-size: {defaultSize}; --dot-bg: {fillBg}" ></div>
    {/if}

    {#if i === currentStepIndex}
      <div class="shepherd-dot" style="--dot-size: {bigSizeAnimated}; --dot-bg: {fillBgAnimated}" > </div>
    {/if}

    {#if i > currentStepIndex && i === previousStepIndex && !movingForward}
      <div class="shepherd-dot" style="--dot-size: {defaultSizeAnimated}; --dot-bg: {defaultBgAnimated}" ></div>

    {:else if i > currentStepIndex}
      <div class="shepherd-dot" style="--dot-size: {defaultSize}; --dot-bg: {defaultBg}" ></div>
    {/if}
