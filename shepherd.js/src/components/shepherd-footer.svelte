<script>
    ...
    $: addtionalButtons = buttons
        .filter(btn => {return btn !== leftButton && btn !== rightButton})
        .filter(btn => !!btn);
...
<footer class="shepherd-footer">
    {#if addtionalButtons && addtionalButtons.length > 0}
        <div
            class="additional-buttons-container margin-top-1"
            class:align-right={!footerPresent} 
            class:grey-border-top={!footerPresent}
        >
    ...
    {#if footerPresent}
        <div
            class="footer-buttons-container grey-border-top"
            class:margin-top-1={!addtionalButtons || addtionalButtons.length === 0}
        >
